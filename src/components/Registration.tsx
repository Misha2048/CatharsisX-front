...
import logo from '../assets/CatharsisX.svg'
...
const RegistrationForm: React.FC = () => {
  ...
  return (
    <div>
      {isToggled ? <SignUp handleToggle={handleToggle} /> : <LogIn handleToggle={handleToggle} />}
    </div>
  )
}
    ...
    <div className={container}>
      <div className={box}>
        <Additional>
          ...
          <SomeText>
            Don’t have an accout? <Link onClick={handleToggle}>Log in</Link>
          </SomeText>
        </Additional>
        <Main>
    ...
    <div className={container}>
      <div className={box}>
        <Additional>
          ...
          <DisplayTitle>Join a community of like-minded people.</DisplayTitle>
          <SomeText>
            Don’t have an accout? <Link onClick={handleToggle}>Sign up</Link>
          </SomeText>
        </Additional>
        <Main>
          <Title>Log in</Title>
